/**
 * Oathsworn official subclasses — subclass-specific migration steps (Heroes 2.0.3 ⇄
 * Nimble 0.2 playtest). Runs after `../classes/oathsworn.mjs`, with the same `ctx`
 * (`ctx.subclass` is the owned Oathsworn subclass item, or null).
 *
