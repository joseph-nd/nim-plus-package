/**
 * Shadowmancer official subclasses — subclass-specific migration steps (Heroes 2.0.3 ⇄
 * Nimble 0.2 playtest). Runs after `../classes/shadowmancer.mjs`, with the same `ctx`
 * (`ctx.subclass` is the owned Shadowmancer subclass item, or null).
 *
 ...
 *
 * 0.2 retires the Reaver's Martyr Spawn (folded into Shadow Exploit).
...
export default restoreModule('shadowmancer', ['reaver']);
