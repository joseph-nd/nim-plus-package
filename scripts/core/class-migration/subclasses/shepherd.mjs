/**
 * Shepherd official subclasses — subclass-specific migration steps (Heroes 2.0.3 ⇄
 * Nimble 0.2 playtest). Runs after `../classes/shepherd.mjs`, with the same `ctx`
 * (`ctx.subclass` is the owned Shepherd subclass item, or null).
 *
