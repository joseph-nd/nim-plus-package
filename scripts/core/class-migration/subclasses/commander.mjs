/**
 * Commander official subclasses — subclass-specific migration steps (Heroes 2.0.3 ⇄
 * Nimble 0.2 playtest). Runs after `../classes/commander.mjs`, with the same `ctx`
 * (`ctx.subclass` is the owned Commander subclass item, or null).
 *
