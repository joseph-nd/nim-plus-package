/**
 * Zephyr official subclasses — subclass-specific migration steps (Heroes 2.0.3 ⇄
 * Nimble 0.2 playtest). Runs after `../classes/zephyr.mjs`, with the same `ctx`
 * (`ctx.subclass` is the owned Zephyr subclass item, or null).
 *
